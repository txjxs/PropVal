...
def get_bq_client():
    ...
    # Note: Assumes GOOGLE_APPLICATION_CREDENTIALS is set in the environment or running on GCP
    # For local development, ensure the GOOGLE_APPLICATION_CREDENTIALS env var points to the service account
